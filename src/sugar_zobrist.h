...
// sugar_zobrist.h
// Generated from Sugar position.cpp
...
// Include this AFTER Sugar defines Zobrist::{psq, enpassant, castling, side, noPawns}
#include "types.h"

namespace SugarZobrist {

inline void SetSugarZobrist() {
