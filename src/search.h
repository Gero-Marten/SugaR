...
// Sugar at various skill levels and various versions of the Stash engine.
...
class Worker {
   ...
   private:
    ...
    // --- Sugar: per-worker Variety config cache ----------------------------
    struct VarietyCfg {
