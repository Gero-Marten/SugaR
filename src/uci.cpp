...
#if defined(SUG_FIXED_ZOBRIST)
// Forward declaration: the definition is in position.cpp (where you include Sugar_zobrist.h)
namespace SugarZobrist { void SetSugarZobrist(); }
